...
const { signUp, checkEmail, logIn, refreshToken, postUser, logOut, getUserDetails, userProfileDetails, userProfileAbout, uploadProfileImage, userToHost, addWishlist, checkAddress } = require("../controllers/authController");
...
router.post("/check_eth", checkAddress)
